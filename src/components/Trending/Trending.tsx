...
export default function Trending() {
  ...
  return (
    <div className="max-w-[1000px] mx-auto px-[1rem] lg:px-0">
      ...
      {!loading && !error && (
        <div className="mt-[2rem] sm:mt-[3rem] grid grid-cols-[repeat(auto-fill,minmax(120px,1fr))] sm:grid-cols-[repeat(auto-fill,minmax(150px,1fr))] items-stretch gap-[2rem_1rem] sm:gap-[2rem_2rem]">
