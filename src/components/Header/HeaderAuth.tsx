  ...
  if (session.status === "loading") {
    ...
    authContent = (
      <div className="flex items-center">
        <Link href="#" className="font-medium mr-8">
          Watchlist
        </Link>
        <div
        ...
        >
          ...
          <div
            ref={profileModalRef}
            className="scale-0 transition absolute w-max right-0 bg-white text-black rounded p-2"
          >
    ...
    authContent = (
      <Link href="/pages/login" className="font-medium mr-8">
        Login
      </Link>
    );
  }
